    ...
    >
      ...
      <footer className="w-full mt-auto border-t-2 border-white/10 flex items-center flex-col sm:flex-row gap-2 py-4 justify-between">
        <div className="flex flex-row gap-2 items-center">
          ...
          <span className="text-white  text-2xl sm:text-[32px] leading-loose">ShotDeckAI</span>
        </div>
        <div className="flex-row content-center text-white text-xs">built with love in bogota ❤️</div>

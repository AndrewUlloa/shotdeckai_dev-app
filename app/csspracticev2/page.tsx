    ...
    <div className="flex flex-col min-h-screen justify-between bg-cover bg-top bg-[url('https://imagedelivery.net/qkb4K12RSBaH1a6IAJIhiQ/02c62267-750d-444a-55cd-40d738b6ee00/public')] sm:bg-[url('https://imagedelivery.net/qkb4K12RSBaH1a6IAJIhiQ/02c62267-750d-444a-55cd-40d738b6ee00/public')] md:bg-[url('https://imagedelivery.net/qkb4K12RSBaH1a6IAJIhiQ/f403c70d-82b9-41c0-95ac-5512ad886500/public')] gap-y-5 px-10 pt-8">
        ...
        <section className="flex flex-col grow justify-start gap-2">
            <div className="flex flex-col gap-2">
                <h1 className="text-2xl leading-none text-white text-center">Your Creative Vision, Realized <br className="sm:block hidden md:hidden lg:hidden xl:hidden 2xl:hidden" /> Instantly—With AI That Feels Like Magic</h1>
